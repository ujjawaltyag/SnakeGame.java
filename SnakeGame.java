...
class Game extends JPanel {
    ...
    private static Font FONT_M = new Font("", Font.BOLD, 20);
    private static Font FONT_M_BOLD = new Font("", Font.BOLD, 20);
    private static Font FONT_L = new Font("", Font.BOLD, 80);
    private static Font FONT_XL = new Font("", Font.BOLD, 140);
    ...
    public Game() {
        ...
        setFocusable(true);
        setBackground(new Color(5, 160, 150));
        //setFontBackground(new Color(5, 160, 150));
    ...
    private void render(Graphics g) {
        ...
        if (status == GameStatus.NOT_STARTED) {
          ...
          drawCenteredString(g2d, "GAME", FONT_XL, 400);
          drawCenteredString(g2d, "Press  any  key  to  start game", FONT_M_BOLD, 500);
        ...
        g2d.drawString("SCORE: " + String.format ("%02d", points), 30, 30);
        g2d.drawString("BEST RUN: " + String.format ("%02d", best), 630, 30);
        ...
        if (status == GameStatus.GAME_OVER) {
            drawCenteredString(g2d, "* Press  enter  to  start  game again * ", FONT_M_BOLD, 350);
